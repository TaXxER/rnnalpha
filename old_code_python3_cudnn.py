...
csvfile = open('data/receipt_phase.csv', 'r')
...
model.add(CuDNNGRU(32, kernel_initializer='glorot_uniform', return_sequences=True, kernel_regularizer=regularizers.l1_l2(0.0001,0.0005), recurrent_regularizer=regularizers.l1_l2(0.0001,0.0005), input_shape=(maxlen, num_features)))
model.add(CuDNNGRU(32, kernel_initializer='glorot_uniform', return_sequences=True, kernel_regularizer=regularizers.l1_l2(0.0001,0.0005), recurrent_regularizer=regularizers.l1_l2(0.0001,0.0005), input_shape=(maxlen, num_features)))
model.add(CuDNNGRU(16, kernel_initializer='glorot_uniform', return_sequences=False, kernel_regularizer=regularizers.l1_l2(0.0001,0.0005), recurrent_regularizer=regularizers.l1_l2(0.0001,0.0005), input_shape=(maxlen, num_features)))
#model.add(SimpleRNN(64, kernel_initializer='glorot_uniform', return_sequences=True, kernel_regularizer=regularizers.l1_l2(0.0001,0.0005), recurrent_regularizer=regularizers.l1_l2(0.0001,0.0005), input_shape=(maxlen, num_features)))
#model.add(SimpleRNN(64, kernel_initializer='glorot_uniform', return_sequences=True, kernel_regularizer=regularizers.l1_l2(0.0001,0.0005), recurrent_regularizer=regularizers.l1_l2(0.0001,0.0005), input_shape=(maxlen, num_features)))
...
model.fit(X, y, validation_split=0.2, callbacks=[early_stopping, model_checkpoint, lr_reducer], batch_size=maxlen, epochs=250)
...
print(np.mean(list(map(lambda x: brier_score_loss(y[x],y_hat[x]),[i[0] for i in enumerate(y)]))))